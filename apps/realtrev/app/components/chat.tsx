...
export default function TravelChatPage(session: any) {
  ...
  const [roleState] = useRecoilState(changeRoleState);
  ...
  useEffect(() => {
    ...
    const socket = io("wss://realtrev-chat.onrender.com"); // Replace with your Cloudflare WebSocket URL
