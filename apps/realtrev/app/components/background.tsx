...
import { Compass, Leaf, Sun, Moon } from "lucide-react";
...
const TravelMinimalBackground: React.FC = () => {
  ...
  return (
    <div
      className={`fixed -z-10 w-full h-screen overflow-hidden transition-colors duration-300 ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}
    >
      ...
      {/* Subtle wave pattern */}
      <div
        className={`absolute inset-0 ${isDarkMode ? "opacity-15" : "opacity-10"}`}
        style={{
