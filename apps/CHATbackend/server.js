...
io.on("connection", (socket) => {
  ...
  socket.on("sendMessage", ({ queryid, senderId, message ,time}) => {
    console.error(`Message received in room ${queryid}: ${message} by ${senderId} at ${time}`);
    ...
    io.to(queryid).emit("receiveMessage", { message, senderId,time });  // Broadcast the message to the room
